            ...
            <div class="panel panel-default">
                <div class="panel panel-body">
                    <table class="table" style="border:1px solid red;">
                        <tr class="row">
                            <th>工作时间</th><th>上班时间</th><th>下班时间</th><th>上班状态</th><th>下班状态</th>
                        </tr>
                        <?php foreach($data as $v):?>
                            <tr class="row">
                                <td><?php echo $v['work_time']?></td><td><?php echo $v['start']?></td><td> <?php echo $v['end']?></td><td> <?php echo $v['S_status']?></td>
                                <td> <?php echo $v['E_status']?></td>
                            </tr>
                        <?php endforeach;?>
                        <a href="<?php echo site_url('backstage/att/user_att')?>"class="btn btn-danger">返回上一级</a>
                    </table>
                </div>
