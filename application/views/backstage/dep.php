            ...
            <div class="panel panel-default">
                <div class="panel panel-body">
                    <table class="table" style="border:1px solid red;">
                        <tr class="row">
                            <th>序号</th><th>部门</th><th>编辑</th>
                        </tr>
                        <?php foreach($data as $v):?>
                            <tr class="row">
                                <td><?php echo $v['id']?></td><td><?php echo $v['name']?></td><td><a href="<?php echo site_url('backstage/dep/update/'.$v['id']);?>" class="btn btn-xs btn-info">修改</a>&nbsp;<a href="<?php echo site_url('backstage/dep/del/'.$v['id']);?>" class="btn btn-xs btn-info">删除</a></td>
                            </tr>
                        <?php endforeach;?>
                    </table>
                    <?php echo form_open('backstage/dep/add')//表示由doedit方法接收表单数据?>
