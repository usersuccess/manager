            ...
            <div class="panel panel-default">
                ...
                <div class="panel panel-body">
                    <form action="./updatePwd" method="post" class="form">
                        用户名:<input type="text" name="name" value="<?php echo $_SESSION['name']?>" readonly="readonly" class="form-inline">
                        密码:<input type="password" name="password" class="form-inline">
                        <input type="submit" name="submit" value="保存" class="btn btn-xs btn-info">
                    </form>
                </div>
            </div>
        </div>
